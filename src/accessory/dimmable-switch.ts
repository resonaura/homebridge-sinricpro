 ...
 */
export class SinricProDimmableSwitch
  ...
  implements SinricProAccessory
{
  ...
  constructor(
    ...
    this.accessory
      ...
      .setCharacteristic(
        ...
        ModelConstants.DIMMABLE_SWIRCH_MODEL,
      )
      .setCharacteristic(
    ...
    this.platform.log.debug(
      '[SinricProDimmableSwitch()]: Adding device:',
  ...
  public updateState(action: string, value: any): void {
    ...
    if (action === ActionConstants.SET_POWER_STATE) {
      ...
      this.service
        .getCharacteristic(this.platform.Characteristic.On)
        .updateValue(this.dimmerStates.on);
    } else if (
      action === ActionConstants.SET_POWER_LEVEL ||
      ActionConstants.ADJUST_POWER_LEVEL
    ) {
      this.dimmerStates.powerLevel = value.powerLevel;
      this.service
        .getCharacteristic(this.platform.Characteristic.Brightness)
        .updateValue(this.dimmerStates.powerLevel);
    }
  }
