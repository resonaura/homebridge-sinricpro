 ...
 */
export class SinricProContactSensor
  ...
  constructor(
    ...
    this.accessory
      ...
      .setCharacteristic(
        ...
        ModelConstants.CONTACT_SENSOR_MODEL,
      )
      .setCharacteristic(
    ...
    this.service.setCharacteristic(
      ...
      `${accessory.context.device.name} Contact Sensor`,
    );
    ...
    this.states.contactState = this.toContactSensorState(
      accessory.context.device.contactState,
    );
    this.service
      .getCharacteristic(this.platform.Characteristic.ContactSensorState)
      .updateValue(this.states.contactState);
  }
